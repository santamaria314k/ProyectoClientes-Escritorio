...
public class ContactoService {
    ...
    public void RegistrarContacto(Contacto contacto) {
        ...
        if (conn != null) {
            try {
                String sql = "INSERT INTO Contactos (nombres, apellidos, correo, telefono, cargo, departamento) VALUES (?, ?, ?, ?, ?, ?)";
                PreparedStatement pstmt = conn.prepareStatement(sql);
                pstmt.setString(1, contacto.getApellidoContac());
                pstmt.setString(2, contacto.getRazonSocial());
